...
export default function Login(): JSX.Element {
  return (
    <section className="flex justify-center items-center content-center lg:mt-30">
      <div className="h-full">
        {/* <!-- Left column container with background--> */}

        <div className="g-6 flex h-full flex-col flex-wrap items-center justify-center lg:justify-between">
          <h1 className="text-white bg-[#0c0c0c60] p-3 text-[16px]">
            Welcome to the login page, Kindly Log in!
          </h1>
          ...
          <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
            <form>
                ...
                <TERipple rippleColor="light">
                  ...
                  >
                    {/* <!-- Whatsapp --> */}
                     <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="mx-auto h-5 w-5 text-bold"
                      fill="currentColor"
                      viewBox="0 0 30 30"
                    >
              ...
              <div
                className="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t 
              ...
              <div className="mb-6 flex items-center justify-between">
                ...
                <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                  <input
                    ...
                    before:opacity-0 before:shadow-[0px_0px_0px_13px_transparent] before:content-[''] checked:border-primary checked:bg-primary checked:before:opacity-[0.16] checked:after:absolute checked:after:-mt-px checked:after:ml-[0.25rem] checked:after:block checked:after:h-[0.8125rem] checked:after:w-[0.375rem] checked:after:rotate-45 
                    ...
                    focus:before:scale-100 focus:before:opacity-[0.12] focus:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:before:transition-[box-shadow_0.2s,transform_0.2s] focus:after:absolute focus:after:z-[1] focus:after:block focus:after:h-[0.875rem] focus:after:w-[0.875rem] focus:after:rounded-[0.125rem] focus:after:content-[''] checked:focus:before:scale-100 
